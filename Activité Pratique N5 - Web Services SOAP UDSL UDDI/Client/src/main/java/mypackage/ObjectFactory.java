...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://ws.example.org/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.example.org/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://ws.example.org/", "compte");
    ...
    private static final QName _ListCompte_QNAME = new QName("http://ws.example.org/", "listCompte");
    private static final QName _ListCompteResponse_QNAME = new QName("http://ws.example.org/", "listCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "listCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "listCompteResponse")
