 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.example.org/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.example.org/", "BanqueWS");
